      ...
      child:Container(
        ...
        child: Column(
          ...
          children: [
            ...
            BigText(text: "Introduce",size: 18.px,),
            SizedBox(height: 20.px,),
            Expanded(
              child: SingleChildScrollView(
                child: ExpandableTextWidget(
                  text: FakerData.ins.lorem.paragraph(sentenceCount:20)
                )
              )
            )
          ],
  ...
  Positioned _buildTopBtn() {
    return Positioned(
      ...
      child: Row(
        ...
        children: [
          AppIcon(icon: Icons.arrow_back_ios,iconSize: 16.px,),
          AppIcon(icon: Icons.shopping_cart_outlined,iconSize: 16.px,),
        ],
      )
    );
  }
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            fit: BoxFit.cover,
            image: NetworkImage(MockImage.imgId(512)),
          )
        ),
      )
    );
